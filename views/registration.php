...
<div class="card card-plain">
    ...
    <div class="card-body">
        <form role="form" method="post" action="/processRegistration">
            <div class="mb-3">
                <input type="text" name="first_name" class="form-control form-control-lg" placeholder="First name" value="<?php echo $params->first_name ?>">
            </div>
            <div class="mb-3">
                <input type="text" name="last_name" class="form-control form-control-lg" placeholder="Last name" value="<?php echo $params->last_name ?>">
            </div>
            <div class="mb-3">
