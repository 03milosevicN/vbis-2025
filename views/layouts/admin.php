...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,...,900i" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                <div class="sidebar-brand-text mx-3">VBIS 2025</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/getUsers">Active users</a>
            </li>
            <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <p>© <span>2025</span> <strong class="px-1">Nikola Milošević</strong> — Licensed under the <a
